...
import static za.co.wethinkcode.robots.config.Config.HOST;
import static za.co.wethinkcode.robots.config.Config.PORT;
import static za.co.wethinkcode.robots.config.Config.loadConfig;
 ...
 * This class handles the client-side logic for interacting with the robot
 * server.
 */
public class Client {
   ...
   * This method prompts the user for the robot type and name, and handles any
   ...
   * This method extracts relevant information from the JSON response and formats
