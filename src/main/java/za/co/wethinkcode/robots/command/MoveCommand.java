...
import static za.co.wethinkcode.robots.UpdateResponse.DIED_FELL_IN_PIT;
import static za.co.wethinkcode.robots.UpdateResponse.FAILURE_OBSTRUCTED;
import static za.co.wethinkcode.robots.UpdateResponse.FAILURE_OUT_OF_BOUNDS;
...
/**
 * The Move class represents a command to move the robot in a specified
 * direction.
 * It extends the Command class and implements the execute method to perform the
 * move action.
 * This class provides a factory method to create instances for forward and back
 * commands.
 */
public class MoveCommand extends Command {
   ...
   * @return A new instance of MoveCommand configured for the specified direction
   *         and steps
  ...
  /**
   * Executes the move command, which changes the position of the robot in the
   * world.
   * The direction and number of steps are determined by the command's name and
   * argument.
   *
