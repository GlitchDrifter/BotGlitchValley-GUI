...
/**
 * The AsciiWorld class is responsible for generating an ASCII representation of
 * the world.
 * It takes a World object and creates a text file with the current state of the
 * world,
